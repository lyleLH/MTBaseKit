...
@implementation NSData (MTExtension)
...
- (NSData *)mt_base64EncodedData {
    return [[self mt_base64Encoded] dataUsingEncoding:NSUTF8StringEncoding];
}
...
- (NSData *)mt_base64DecodedData {
    NSString *string = [NSString mt_stringWithData:self encoding:NSUTF8StringEncoding];
    if(string == nil) {
        return nil;
    }
    if([string length] == 0) {
...
- (NSString *)mt_base64Decoded {
    return [NSString mt_stringWithData:[self mt_base64DecodedData] encoding:NSUTF8StringEncoding];
}
