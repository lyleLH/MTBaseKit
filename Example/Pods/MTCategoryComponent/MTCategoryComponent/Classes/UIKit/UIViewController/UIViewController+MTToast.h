...
typedef NS_ENUM(NSUInteger, kMTToastPositionType) {
    kMTToastPositionType_Top,
    kMTToastPositionType_Center,
    kMTToastPositionType_Bottom,
};

@interface UIViewController (MTToast)
